import Browser
import Html exposing (Html, Attribute, button, div, text, input, h2, h3, li, ul, br)
import Html.Attributes exposing(placeholder, size, value)
import Html.Events exposing (onClick, onInput, on, keyCode)
import Http
import Json.Decode exposing (Decoder, field, list, string, map, map4, maybe)
